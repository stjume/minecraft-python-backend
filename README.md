...
- `spawnEntity <x:int> <y:int> <z:int> <entityid:String>`
  ...
  - `example`: A command could look like this: `spawnEntity 10 10 10 Zombie` and a possible return value could look like this `ff568527-7c0c-4536-aed2-ef77429d61b8`
